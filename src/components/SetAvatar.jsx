...
import { AvatarPost } from "../utils/APIRoutes";
...
export default function SetAvatar() {
  ...
  const setProfilePicture = async () => {
    if (selectedAvatar === undefined) {
      ...
      const { data } = await axios.post(`${AvatarPost}${user._id}`, {
      ...
      if (data.isSet) {
        ...
        const {avatarImage, ...other} = user;
        const JsonUser = JSON.stringify(other);
